...
import { ENGrid } from "../utils/engrid";

export default class VGS {
  ...
  dumpGlobalVar() {
    ...
    (window as any).enVGSFields = this.options;
    ...
    (window as any).setTimeout(() => {
      ...
      if (vgsIElements.length > 0) {
        ...
        if (
          ...
          (window as any).EngagingNetworks.require._defined.enjs.vgs.init();
        }
      }
    }, 1000);
  }
